...
public class AES256 extends BlockCipher {
	...
	private final static int unpack(byte[] bytes, int index) {
		return (bytes[index] & 0xff) | ((bytes[index + 1] & 0xff) << 8) | ((bytes[index + 2] & 0xff) << 16)
				| (bytes[index + 3] << 24);
	}
	...
	private final static long[] S_packed = { 0xc56f6bf27b777c63L, 0x76abd7fe2b670130L, 0xf04759fa7dc982caL,
			0xc072a49cafa2d4adL, 0xccf73f362693fdb7L, 0x1531d871f1e5a534L, 0x9a059618c323c704L, 0x75b227ebe2801207L,
			0xa05a6e1b1a2c8309L, 0x842fe329b3d63b52L, 0x5bb1fc20ed00d153L, 0xcf584c4a39becb6aL, 0x85334d43fbaaefd0L,
			0xa89f3c507f02f945L, 0xf5389d928f40a351L, 0xd2f3ff1021dab6bcL, 0x1744975fec130ccdL, 0x73195d643d7ea7c4L,
			0x88902a22dc4f8160L, 0xdb0b5ede14b8ee46L, 0x5c2406490a3a32e0L, 0x79e4959162acd3c2L, 0xa94ed58d6d37c8e7L,
			0x08ae7a65eaf4566cL, 0xc6b4a61c2e2578baL, 0x8a8bbd4b1f74dde8L, 0x0ef6034866b53e70L, 0x9e1dc186b9573561L,
			0x948ed9691198f8e1L, 0xdf2855cee9871e9bL, 0x6842e6bf0d89a18cL, 0x16bb54b00f2d9941L };

	private final static long[] Si_packed = { 0x38a53630d56a0952L, 0xfbd7f3819ea340bfL, 0x87ff2f9b8239e37cL,
			0xcbe9dec444438e34L, 0x3d23c2a632947b54L, 0x4ec3fa420b954ceeL, 0xb224d92866a12e08L, 0x25d18b6d49a25b76L,
			0x1698688664f6f872L, 0x92b6655dcc5ca4d4L, 0xdab9edfd5048706cL, 0x849d8da75746155eL, 0x0ad3bc8c00abd890L,
			0x0645b3b80558e4f7L, 0x020f3fca8f1e2cd0L, 0x6b8a130103bdafc1L, 0xeadc674f4111913aL, 0x73e6b4f0cecff297L,
			0x8535ade72274ac96L, 0x6edf751ce837f9e2L, 0x89c5291d711af147L, 0x1bbe18aa0e62b76fL, 0x2079d2c64b3e56fcL,
			0xf45acd78fec0db9aL, 0x31c7078833a8dd1fL, 0x5fec8027591012b1L, 0x0d4ab519a97f5160L, 0xef9cc9939f7ae52dL,
			0xb0f52aae4d3be0a0L, 0x619953833cbbebc8L, 0x26d677ba7e042b17L, 0x7d0c2155631469e1L };
	...
	private final static int[] rcon = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab,
			0x4d, 0x9a, 0x2f, 0x5e, 0xbc, 0x63, 0xc6, 0x97, 0x35, 0x6a, 0xd4, 0xb3, 0x7d, 0xfa, 0xef, 0xc5, 0x91 };

	private final static int[] T0 = { 0xa56363c6, 0x847c7cf8, 0x997777ee, 0x8d7b7bf6, 0x0df2f2ff, 0xbd6b6bd6,
	...
	private final static int[] T1 = { 0x6363c6a5, 0x7c7cf884, 0x7777ee99, 0x7b7bf68d, 0xf2f2ff0d, 0x6b6bd6bd,
	...
	private final static int[] T2 = { 0x63c6a563, 0x7cf8847c, 0x77ee9977, 0x7bf68d7b, 0xf2ff0df2, 0x6bd6bd6b,
	...
	private final static int[] T3 = { 0xc6a56363, 0xf8847c7c, 0xee997777, 0xf68d7b7b, 0xff0df2f2, 0xd6bd6b6b,
	...
	private final static int[] Tinv0 = { 0x50a7f451, 0x5365417e, 0xc3a4171a, 0x965e273a, 0xcb6bab3b, 0xf1459d1f,
	...
	private final static int[] Tinv1 = { 0xa7f45150, 0x65417e53, 0xa4171ac3, 0x5e273a96, 0x6bab3bcb, 0x459d1ff1,
	...
	private final static int[] Tinv2 = { 0xf45150a7, 0x417e5365, 0x171ac3a4, 0x273a965e, 0xab3bcb6b, 0x9d1ff145,
	...
	private final static int[] Tinv3 = { 0x5150a7f4, 0x7e536541, 0x1ac3a417, 0x3a965e27, 0x3bcb6bab, 0x1ff1459d,
	...
	public void test() throws Throwable {
		...
		final byte[] TEST_KEY = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
				0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e,
				0x1f, };
		final byte[] REF_PTXT = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, (byte) 0x88, (byte) 0x99, (byte) 0xaa,
				(byte) 0xbb, (byte) 0xcc, (byte) 0xdd, (byte) 0xee, (byte) 0xff };
		final byte[] REF_CTXT = { (byte) 0x8e, (byte) 0xa2, (byte) 0xb7, (byte) 0xca, 0x51, 0x67, 0x45, (byte) 0xbf,
				(byte) 0xea, (byte) 0xfc, 0x49, (byte) 0x90, 0x4b, 0x49, 0x60, (byte) 0x89 };
