 ...
 */
public abstract class BlockCipher implements Cloneable {
	/** Operation modes. */
	public enum Mode {
	 ...
	 *            The operation mode.
	 * @param key
	 *            Buffer to the key material.
	 * @param ofs
	 *            Where the key material starts in the buffer.
	 */
	 ...
	 *            The input buffer.
	 * @param ofs_i
	 *            Where the block is read from in the input buffer.
	 * @param out
	 *            The output buffer.
	 * @param ofs_o
	 *            Where the processed block is written to the output buffer.
	 */
